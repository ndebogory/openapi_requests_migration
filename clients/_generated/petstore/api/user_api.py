...
from clients._generated.petstore.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class UserApi(object):
    ...
    def login_user_with_http_info(self, username, password, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'username' in local_var_params and not re.search(r'^[a-zA-Z0-9]+[a-zA-Z0-9\.\-_]*[a-zA-Z0-9]+$', local_var_params['username']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `username` when calling `login_user`, must conform to the pattern `/^[a-zA-Z0-9]+[a-zA-Z0-9\.\-_]*[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
